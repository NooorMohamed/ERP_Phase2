...
class MediaCentre extends React.Component {
    constructor() {
     super();
     this.state = {
         num : 1,
          ...
          <div className="col-md-8">
             <div className="noborder">      
               <div className="thumbnail">
                 <img id="swapImg" src={require(this.state.img_src)}/>
              </div>
             </div>     
          </div>
         ...
         <div className="col-md-4">
          <div className="noborder">
           <div className="thumbnail thumbnailp3">
              <p style={{fontSize:'22px',paddingLeft:'40px',paddingTop:'10px'}}>{this.state.description}</p>
            <hr/>
              <p style={{fontSize:'20px',paddingLeft:'40px'}}><span className="mycontent-right"style={{fontSize:'20px',fontWeight:'normal'}}><span style={{fontWeight:'bold'}}id='counterValue'>{this.state.num}/8</span>&nbsp;</span>
                   &nbsp;
             {this.state.title}</p>     
