        ...
        <div className="thumbnail">
         <img className= "otherViewImg" src = {require(this.state.img_src)}/>    
           <div className= "thumbnail thumbclone">  
            <p className= "page_2_paragraph1"><span className="mycontent-right"style={{fontSize:'20px',fontWeight:'normal'}}><span style= {{fontWeight:'bold'}}>{this.state.num} / 8</span>&nbsp;</span>
                   &nbsp;
